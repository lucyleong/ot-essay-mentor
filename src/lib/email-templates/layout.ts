        ...
        <tr>
          <td style="background:#f5f4f0;border:1px solid #e8e6de;border-top:none;border-radius:0 0 12px 12px;padding:20px 32px;">
            <p style="margin:0;font-size:12px;color:#888780;line-height:1.6;">
              ...
              If you have questions, contact your program coordinator.
            </p>
          </td>
        </tr>
...
export function detailRow(label: string, value: string) {
  return `
    <tr>
      <td style="padding:8px 0;font-size:13px;color:#888780;width:140px;vertical-align:top;">${label}</td>
      <td style="padding:8px 0;font-size:13px;color:#2C2C2A;font-weight:500;">${value}</td>
    </tr>`
}
