...
<a href="/mentors" style={{ color: '#534AB7' }}>Read about the team here.</a>
        ...
        <div style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            {[
              { num: '1', title: 'Sign up online', desc: 'Browse available appointment slots and book the one that works for you. A personal Gmail address is required. First come, first served.' },
