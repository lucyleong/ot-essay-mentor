...
if (q.question_text === 'Which mentor have you worked with?' && !showMentor && !isReturning) return false        return true
            })
    .flatMap(q => {
    ...
    {phoneError}
         ...
         {questions
              .filter(q => {
                if (q.sort_order <= 4) return false
                if (q.question_text === 'I worked with a College Essay Mentor in Spring 2026 through this program' && isReturning) return false
if (q.question_text === 'Which mentor have you worked with?' && !showMentor) return false                console.log('question:', q.question_text, 'showMentor:', showMentor, 'isReturning:', isReturning)
        if (isReturning) {
