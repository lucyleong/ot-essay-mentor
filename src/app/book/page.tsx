...
const isOptional = !q.is_required
            ...
            <div style={{
              ...
              <p style={{ fontSize: 13, fontWeight: 500, margin: '0 0 6px', color: '#2C2C2A' }}>
                Statement on AI
              </p>
              <p style={{ fontSize: 12, color: '#5F5E5A', margin: '0 0 10px', lineHeight: 1.6 }}>
                The Common App. and the UC system both prohibit the use of AI to generate college
                application essays. UC runs plagiarism checks on applications, and if your PIQs are
                found to have been generated by AI with unattributed sources, you could be
                disqualified from UC admission entirely. The Oakland Tech College Essay Mentors,
                similarly, require drafts and essays to be your own work. In order to complete your
                request for an appointment, please enter your name to confirm your agreement with
                the following statement:
              </p>
              <p style={{ fontSize: 12, color: '#2C2C2A', fontStyle: 'italic', margin: '0 0 12px', lineHeight: 1.6 }}>
                I understand that, by signing up to work with an Oakland Tech College Essay Mentor,
                I certify that the essays with which I am asking for help are my own work, and have
                not been generated entirely or in part by artificial intelligence.
              </p>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 500, color: '#5F5E5A', marginBottom: 4 }}>
                Type your full name to sign <span style={{ color: '#E24B4A' }}>*</span>
              </label>
              <input
                type="text"
                value={aiStatementSignature}
                onChange={e => setAiStatementSignature(e.target.value)}
...
<div
           ...
           <p id="turnstile-error" style={{ display: 'none', fontSize: 12, color: '#791F1F', marginBottom: 8 }}>
            ...
            <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
              <button
                type="submit"
                disabled={submitting || !!emailError || !!phoneError || !email || !firstName || !lastName || !phone || !aiStatementSignature.trim()}
