    ...
    {phoneError}
             ...
             {phone && (
                <label style={{ display: 'flex', alignItems: 'flex-start', gap: 8, fontSize: 12, color: '#5F5E5A', marginTop: 8, cursor: 'pointer' }}>
                  ...
                  />
                  <span>
                    By signing up, you agree to receive SMS messages from the OT College Mentor Program. Message frequency varies. Message and data rates may apply. Reply HELP for help or STOP to opt-out. See our{' '}
